...
Return only the rewritten text without explanations.`;
  ...
  // Default: Simple directive for intelligence optimization
  return `Make this text more insightful and intellectually rigorous. Focus on:
- Fresh perspectives rather than cliches
- Clear, direct reasoning
- Well-developed points with logical progression
- Precise language that enhances rather than obscures meaning
- Original thinking rather than conventional wisdom
