...
export class IntelligenceEvaluationService {
  ...
  async evaluateIntelligence(text: string, provider: 'openai' | 'anthropic' = 'openai'): Promise<EvaluationResult> {
  ...
  async evaluateOriginality(text: string, provider: 'openai' | 'anthropic' = 'openai'): Promise<EvaluationResult> {
  ...
  private async phase1Evaluation(text: string, questions: string, provider: 'openai' | 'anthropic'): Promise<string> {
