 ...
 */
export async function anthropicAssess(opts: { inputText: string; styleText?: string; params?: Record<string, unknown> }): Promise<AssessmentResult> {
  return await assessWithAnthropic(opts.inputText);
}
